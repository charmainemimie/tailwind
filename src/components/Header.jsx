...
<nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 mb-4">
  ...
  <a href="https://6ixelement.club/index.php" className="flex items-center">
      <img src="https://6ixelement.club/images/logo-white.svg" className="h-8 mr-3" alt="6ixElement Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">6ixElement</span>
  </a>
